 ...
 *
 */
public class FirmHoldSum implements Serializable {

	private static final long serialVersionUID = -8918644844535702415L;
	...
	public FirmHoldSum(String firmId, String commodityId, int bsFlag) {
		this.firmId = firmId;
