 ...
 */
package com.yrdce.ipo.common.persistence;
...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			...
			sb.append("<li><a href=\"javascript:\" onclick=\"" + funcName + "(" + prev + "," + pageSize + ",'" + funcParam
					+ "');\">&#171; 上一页</a></li>\n");
		}
		...
		for (int i = end + 1; i <= last; i++) {
			sb.append("<li><a href=\"javascript:\" onclick=\"" + funcName + "(" + i + "," + pageSize + ",'" + funcParam + "');\">" + (i + 1 - first)
					+ "</a></li>\n");
		}
