...
public class ChargeItemController {
	...
	@ResponseBody
	public String queryTopLevel(@RequestParam("page") String pageNo,
		...
		if (count > 0) {
			dataList = chargeItemService.querySubLevelForPage(pageNo, pageSize,
					chargeItem);
		}
	...
	@ResponseBody
	public String querySubLevel(@RequestParam("page") String pageNo,
			@RequestParam("rows") String pageSize, HttpServletRequest request)
			throws Exception {
		ChargeItem chargeItem = new ChargeItem();
	...
	public String edit(HttpServletRequest request, Model model)
		...
		chargeItem.setParentId(ChargeItem.TOP_LEVEL_ID);
		List<ChargeItem> dataList = chargeItemService.queryForList(chargeItem);
		ChargeItem entity = chargeItemService.findById(request
				.getParameter("id"));
