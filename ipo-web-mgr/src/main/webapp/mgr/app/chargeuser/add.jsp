		...
		<script type="text/javascript"> 
			function save(){
				 ...
				 if(dataForm.amount.value==""){
		    	  ...
		    	  $.ajax({  
		  		    url: "<%=request.getContextPath()%>/chargeUserController/save",  
		  		    ...
		  		    success : function(data, stats) {  
		  	             if(data=="success"){
		  	            	 ...
		  	            	 alert('绑定的业务,角色,费用,用户已经存在,请勿重复添加');
		  	             }
		  	        },
							...
							<td colspan="4">
								...
								<table cellSpacing="0" cellPadding="0" width="790" border="0" align="left" class="common">   
        							...
        							<tr style="height: 20px">   
            							...
            							<td> <input name="userId" type="text" size="26" style="height: 24px;" maxlength="32" />
			  								 <font style="color:red">*</font> 
            							</td> 
        							</tr>
        							<tr style="height: 30px">   
