...
<script src="<%=request.getContextPath()%>/static/jquery-easyui/jquery.easyui.min.js"  type="text/javascript"></script>
  ...
  $(document).ready(function() {
    $('#dg').datagrid({
      url: '<%=request.getContextPath()%>/payFlowController/queryPublishGoods?t='+Math.random(), //从远程站点请求数据的 URL。
      method:"post",
  ...
  function pay(id){
	  var url_="<%=request.getContextPath()%>/payFlowController/pay?t="+Math.random();
	  $.ajax({  
		    url: url_,  
		    data:{"id":id},  
