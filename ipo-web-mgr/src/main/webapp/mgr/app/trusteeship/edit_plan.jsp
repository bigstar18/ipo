...
<body leftmargin="14" topmargin="0" onload="init();">
<div class="warning">
								...
								<table cellSpacing="0" cellPadding="0" width="790" border="0" align="left" class="common">   
            							...
            							<td> 
            							    <select name="commodityId" style="width:150px;">
            							      ...
            							      <c:forEach items="${commodityList }" var="item">
            							        <option value="${item.commodityid }" 
            							          <c:if test="${item.commodityid ==entity.commodityId }">selected</c:if>
            						...
            						<tr style="height: 30px">   
            							...
            							<td> 
            							    ...
            							    <input name="plan" type="hidden" size="23"  style="height: 24px;" value="${entity.plan }"/>  
			  								<font style="color:red">*</font>
            							</td> 
        							</tr>
        							<tr style="height: 30px">   
        							...
        							<tr style="height: 30px">   
            							...
            							<td> <textarea name="remark" rows="5" cols="21">${entity.remark }</textarea> 
            							</td> 
        							</tr>
	 							</table >
								 </fieldset> 
