								...
								<table cellSpacing="0" cellPadding="0" width="790" border="0" align="left" class="common">   
									...
									<tr>
            							...
            							<td><input id="commodityname" name="commodityname" value="${entity.commodityname }"
            								class="easyui-validatebox textbox" data-options="required:true"  style="width: 80; background-color: gray" readonly="readonly"/>          
            							</td>    
							        ...
							        <tr>
            							...
            							<input id="supervisedprice" name="supervisedprice" value="${entity.supervisedprice }"
            								class="easyui-validatebox textbox" data-options="required:true,missingMessage:'必填项'" onkeypress="return onlyNumberInput()" style="width: 80; background-color: C0C0C0"/>
							            </td>        
