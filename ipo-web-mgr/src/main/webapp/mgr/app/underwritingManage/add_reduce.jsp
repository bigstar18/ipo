	...
	<head>
		...
		<script type="text/javascript"> 
			...
			function back(){
				...
				var url_='<%=request.getContextPath()%>/UnderwriterSetController/reduceSet?id='+positionFlowId_+'&&randnum='+Math.floor(Math.random()*1000000);
...
<div class="warning">
		<div class="title font_orange_14b">温馨提示 :添加分期解冻设置信息 <font style="color: red">*号为必填项</font></div>
	</div>
