...
<body>
 ...
 <%
	...
	String sql = " select to_char(t.settleprocessdate,'yyyy-MM-dd') settleprocessdate,t.commodityid commodityid,(case when t.bs_flag=1 then '买' else '卖' end) bs,"+
				" t.firmid firmid,t.customerid customerid,(t.holdqty+t.gageqty) amount,t.price price,settlePrice,t.payout payout,t.settleaddedtax happenmatchtax "+/* 添加t.happenmatchtax BY hxx */
	...
	<td class="td_reportRdHead">增值税</td>
	</tr>
    <%    	
