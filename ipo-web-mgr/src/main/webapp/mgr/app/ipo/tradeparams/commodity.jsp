...
<table width="850" border="0" align="center"  class="common" cellpadding="0" cellspacing="0">
<!-- 基本信息 -->
        <tr class="common">
          <td colspan="4">
            <fieldset>
...
<table cellSpacing="0" cellPadding="0"  width="100%" border="0" align="center" class="common">
        ...
        <tr> 
            ...
            <td align="right" width="80">当前状态：</td>
            	<td width="110">
				<select id="status" name="entity.status" style="width:80" class="validate[required] input_text datepicker">
					<option value=""></option>
					...
					<c:if test="${entity.status == 1}">
						<option value="1" selected="selected">转入交收</option>				    
				    </c:if>				
			   </select> 
...
<table cellSpacing="0" cellPadding="0" width="780" border="0" align="center" class="common">                     
         <tr>
            ...
            <td>
            	<input type="text" id="minPriceMove" name="entity.minPriceMove" maxlength="11" value="${entity.minPriceMove }"
            		style="ime-mode:disabled; width: 70" onkeypress="return suffixNamePress()" class="validate[maxSize[10],custom[onlyDoubleSp]] input_text"/>  
			    <span class="required">*</span>          
            </td>
			 ...
			 <td>
				<input type="text" size="10" id="minQuantityMove" name="entity.minQuantityMove" value="${entity.minQuantityMove }"
					style="width:60" onkeyup="value=value.replace(/[^\d]/g,'')" maxlength="10" class="input_text datepicker" />
				<span class="required">*</span>
			</td>
		</tr>
		<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
         <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
          ...
          <tr>
			...
			<td><input type="text" size="10" id="spreadUpLmt" name="entity.spreadUpLmt" maxlength="10" value="${entity.spreadUpLmt }"
				style="ime-mode:disabled; width: 70" onkeypress="return suffixNamePress()" class="validate[required] input_text datepicker" />
            ...
            <td>
			  <input type="text" size="10" id="spreadDownLmt" name="entity.spreadDownLmt" maxlength="10" value="${entity.spreadDownLmt }"
			  	style="ime-mode:disabled; width: 60" onkeypress="return suffixNamePress()" class="validate[required] input_text datepicker" />
     ...
     <tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
		...
		<tr>
            ...
            <td>
				<select id="taxInclusive" name="entity.taxInclusive" style="width:80" class="validate[required]">
				    <option value="1" <c:if test="${entity.taxInclusive==1 }">selected</c:if>="">否</option>
					<option value="0" <c:if test="${entity.taxInclusive==0 }">selected</c:if>="">是</option>
			   </select> <span class="required">*</span>            
            </td>  
            <td align="right">
				增值税率：
			...
			<td>
				<input type="text" size="10" id="addedTax" name="entity.addedTax" maxlength="10" value="${entity.addedTax}" style="width:60" class="validate[required] input_text datepicker" onkeypress="return suffixNamePress()">
                  ...
                  <td>
                    <c:forEach var="tradeTime" items="${listSection}" varStatus="status">
                      ...
                      <c:out value="${tradeTime.name}"/>
								...
								<div class="div_gn">
								    <c:if test="${opr == 'cur'}">
									    <c:if test="${request.crud == 'create'}">
									    	<rightButton:rightButton name="添加" onclick="" className="anniu_btn" action="/timebargain/tradeparams/addCommodity.action" id="add"></rightButton:rightButton>
									    </c:if>
									    <c:if test="${request.crud == 'update' && entity.status != 1}">
									    	<rightButton:rightButton name="提交" onclick="" className="anniu_btn" action="/timebargain/tradeparams/updateCommodity.action" id="update"></rightButton:rightButton>
									    </c:if>
									    &nbsp;&nbsp;
									    <rightButton:rightButton name="返回" onclick="" className="anniu_btn" action="/timebargain/tradeparams/detailToCommodity.action" id="back"></rightButton:rightButton>
									</c:if>
								</div>
							</td>
						</tr>
						...
						<input type="hidden" id="forceCloseFeeAlgr" name="entity.forceCloseFeeAlgr" value="${entity.feeAlgr }" />
