...
<script src="<%=request.getContextPath()%>/static/jquery-easyui/jquery.easyui.min.js"  type="text/javascript"></script>
  ...
  $(document).ready(function() {
	    $('#dg').datagrid({
	      url: '<%=request.getContextPath()%>/chargeItemController/queryTopLevel?t='+Math.random(), //从远程站点请求数据的 URL。
	      method:"post",
	      height:430,
	  ...
	  function add(){
		  var url_='<%=request.getContextPath()%>/chargeItemController/add?t='+Math.random();
		  window.open(url_);
	  };
