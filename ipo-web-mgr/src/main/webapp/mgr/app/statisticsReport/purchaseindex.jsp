...
<script type="text/javascript">
	...
	function examine(){
		  ...
		  if(time == "" || time == null){
		      ...
		      window.open("<%=request.getContextPath()%>/statisticsReportController/purchaseInfo?time="+time+"&&commid="+commid,"报表页面",'height=' + iHeight + ',,innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth +  ',top=' + iTop + ',left=' + iLeft+",scrollbars=yes,location=no"); 
		  }
	}
					...
					<fieldset>
						...
						<table border="0" align="center" cellpadding="5" cellspacing="5" class="common" >
							...
							<tr>
								...
								<td>
									<input id="commid" name="commid" type="text" size=8 maxlength=8 />
								  
									<select name="commid"  onchange="setFirmid(value)">
