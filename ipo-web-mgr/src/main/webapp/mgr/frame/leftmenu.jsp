			...
			<div id="div_Container" align="left">
				...
				<div class="leftMenu_div">
					<div id="div_drw_Panel" align="left" curDrwNo="0"
						...
						<a href="#" onclick="setFastMenu();"><span style="font-size: 12; text-decoration: none;" curDrwNo="0">修改设置</span>
						</a>
					</div>
					...
					<div id="tree">
						<script type="text/javascript">
							         var M01;
							         var M0101;
							         M01 = new WebFXTree("<img src='http://10.0.100.182:10061/ipo_mgr/mgr/skinstyle/gray/image/app/ipo_mgr/menu/42_42.gif'> 交易参数设置","");
						</script>
						<script type="text/javascript">
									M0101 = new WebFXTreeItem("交易节管理,http://10.0.100.182:10061/ipo_mgr/mgr/skinstyle/gray/image/app/ipo_mgr/menu/29_29.gif","http://10.0.100.182:10061/ipo_mgr/IpoController/tradeTimeManage");
									M01.add(M0101);
						</script>
						<script type="text/javascript">
									M0101 = new WebFXTreeItem("商品管理,http://10.0.100.182:10061/ipo_mgr/mgr/skinstyle/gray/image/app/ipo_mgr/menu/29_29.gif","http://10.0.100.182:10061/ipo_mgr/IpoController/CommodityManage");
									M01.add(M0101);
						</script>
						...
						<img src="http://10.0.100.182:10061/ipo_mgr/mgr/skinstyle/gray/image/app/ipo_mgr/menu/42_42.gif"> 交易参数设置</span>
						</div>	
                        ...
                        <span title="交易节管理" onclick="goto('http://10.0.100.182:10061/ipo_mgr/IpoController/tradeTimeManage','交易节管理','交易参数设置')">
                        <a name="third" id="webfx-tree-object-7-anchor" style="font-size: 12px;" onfocus="webFXTreeHandler.focus(this);" onblur="webFXTreeHandler.blur(this);" href="javascript:void(0)">交易节管理</a></span></div>							
						...
						<span title="商品管理" onclick="goto('http://10.0.100.182:10061/ipo_mgr/IpoController/CommodityManage','商品管理','交易参数设置')">
						<a name="third" id="webfx-tree-object-8-anchor" style="font-size: 12px;" onfocus="webFXTreeHandler.focus(this);" onblur="webFXTreeHandler.blur(this);" href="javascript:void(0)">商品管理</a></span></div>	
