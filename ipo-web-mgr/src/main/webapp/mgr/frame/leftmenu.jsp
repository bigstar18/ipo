				...
				<div id="div_drw_Content" style="display: inline;">
					...
					<SCRIPT type=text/javascript>
						...
						<SCRIPT type=text/javascript>
								var M01;
								var M0101;
								M01 = new WebFXTree("<img src='<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/42_42.gif'> 交易商权限设置","");</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("权限分配,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/tradingAuthority/authority_trade.jsp");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
						        	document.write(M01);</SCRIPT>   	
						...
						<SCRIPT type=text/javascript>
									...
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("摇号规则配置,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/pubManager/issuedAdmin.jsp");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
						...
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("经纪会员结算表,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/brokerageReportController/brokerid");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("经纪会员经纪收入表,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/brokerageReportController/ibrokerid");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
						...
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("商品承销信息,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/underwritingQuery/commodityinfo.jsp");
									M01.add(M0101);</SCRIPT>
						...
						<SCRIPT type=text/javascript>
									...
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("认购资金处理,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/underwritingManage/subFundsProcessing.jsp");
									M01.add(M0101);</SCRIPT>
                        <SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("承销商分期解冻,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/underwritingManage/reduce.jsp");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
						        	document.write(M01);</SCRIPT>
						<SCRIPT type=text/javascript>
						...
						<SCRIPT type=text/javascript>
									...
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("发行货款跟踪,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/publisherQuery/publish_goods.jsp");
									M01.add(M0101);</SCRIPT>
						...
						<SCRIPT type=text/javascript>
								var M01;
								var M0101;
								M01 = new WebFXTree("<img src='<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/42_42.gif'> 统计报表","");</SCRIPT>
                        <SCRIPT type=text/javascript>
						...
						<SCRIPT type=text/javascript>
									...
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
									M0101 = new WebFXTreeItem("数据项配置,<%=basePath%>/mgr/skinstyle/default/image/app/timebargain_mgr/menu/29_29.gif","<%=basePath%>/mgr/app/dataitem/index.jsp");
									M01.add(M0101);</SCRIPT>
						<SCRIPT type=text/javascript>
						        	document.write(M01);</SCRIPT>
