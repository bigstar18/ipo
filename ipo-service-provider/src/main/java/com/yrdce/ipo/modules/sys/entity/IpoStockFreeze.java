...
public class IpoStockFreeze {
    ...
    @Override
   	public String toString() {
   		return "IpoStockFreezerecords [applicationId=" + applicationId
   				+ ", commodityid=" + commodityid + "  , customerid=" + customerid + ", freezeNumber=" + freezeNumber + ", state=" + state + " ,  createtime=" + createtime + "  , reviewtime=" + reviewtime + ", operator=" + operator +", freezereason=" + freezereason+ " ]";
