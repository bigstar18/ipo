...
public interface IpoCommodityConfMapper {
	...
	List<IpoCommodityConf> findIpoCommConfByBreedid(@Param("breedid") Long breedid, @Param("beginnum") int beginnum,
	...
	List<IpoCommodityConf> findCommodityByWarehouse(@Param("warehouseId") long warehouseId);// 获取在某仓库可入库的商品

	List<IpoCommodityConf> findAvaiSubscribeCommoditys();// 获取可供承销认购的商品

	List<IpoCommodityConf> getcommIdAndName();// 获取配置商品id和name
