...
public interface TCustomerholdsumMapper {
	int deleteByPrimaryKey(@Param("customerid") String customerid, @Param("commodityid") String commodityid, @Param("bsFlag") Short bsFlag);

	int insert(TCustomerholdsum record);

	TCustomerholdsum selectByPrimaryKey(@Param("customerid") String customerid, @Param("commodityid") String commodityid,
