...
<script src="<%=request.getContextPath()%>/static/jquery-easyui/jquery.easyui.min.js"  type="text/javascript"></script>
  ...
  $(document).ready(function() {
	 ...
	 function auditPass(id){
		 $.ajax({  
	  		    url: "<%=request.getContextPath()%>/trusteeshipCommodityController/warehouseFirstAuditPass",  
	  		    data:{"id":id},  
     ...
     function auditNoPass(id){
    	 $.ajax({  
	  		    url: "<%=request.getContextPath()%>/trusteeshipCommodityController/warehouseFirstAuditNoPass",  
	  		    data:{"id":id},  
	  		    type: 'POST',dataType: 'json',  
	  		    success : function(data, stats) {  
	  	             if(data==true||data=="true"){
