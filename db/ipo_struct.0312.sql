...
-- Created by hxx on 2016/3/12, 21:35:04 ---------
--------------------------------------------------

set define off
spool ipo_struct.0312.log
...
prompt
prompt Creating trigger STOCK_AUTOINCREMENT
prompt ====================================
prompt
CREATE OR REPLACE TRIGGER STOCK_AUTOINCREMENT
BEFORE INSERT ON IPO_STOCK_TRANSFERRECORDS
FOR EACH ROW
WHEN (NEW.APPLICATION_ID IS NULL)
BEGIN
SELECT SEQ_TEST.NEXTVAL INTO :NEW.APPLICATION_ID FROM DUAL;
END;
/

prompt
prompt Creating trigger STOCK_AUTOINCREMENT2
prompt =====================================
prompt
CREATE OR REPLACE TRIGGER STOCK_AUTOINCREMENT2
BEFORE INSERT ON ipo_stock_freeze
FOR EACH ROW
WHEN (NEW.APPLICATION_ID IS NULL)
BEGIN
SELECT stock_freeze.NEXTVAL INTO :NEW.APPLICATION_ID FROM DUAL;
END;
/
