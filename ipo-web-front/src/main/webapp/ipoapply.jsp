      ...
      <form class="form-inline" id="fm2" style="margin-top: 20px">
		...
		<br>
		   ...
		   <table class="easyui-datagrid"  title="投资者配号查询"   style="width:100%;height:345px"
            data-options="singleSelect:true,collapsible:false,pagination:true,pageSize:10,pageList:[10,15,20,25],fitColumns:true,url:'<%=request.getContextPath()%>/CommodityController/findComms',method:'get'">
        <thead>
            <tr>
                <th data-options="field:'commodityid',width:200">产品代码</th>
                <th data-options="field:'commodityname',width:200">申购产品</th>
                <th data-options="field:'price',width:180">起始配号</th>
                <th data-options="field:'units',width:200">配号数量</th>
                <th data-options="field:'starttime',width:200,formatter:dateconvertfunc">配号时间</th>
            </tr>
        </thead>
    </table>
			</div>
...
function showInfo(str){
        ...
        xmlhttp.onreadystatechange=function() { 
        	if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		           ...
		           document.getElementById("comname").innerHTML=com.commodityname;
		           document.getElementById("money").innerHTML=com.price;
		           document.getElementById("counts").innerHTML=com.units;
		           document.getElementById("limit").innerHTML=com.units;
	               }
	         }
	        else{
		  document.getElementById("comname").innerHTML="";
